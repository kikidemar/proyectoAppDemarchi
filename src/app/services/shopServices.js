...
export const { useGetProductsQuery, useGetProductQuery, useGetCategoriesQuery, usePostProfileImageMutation, useGetProfileImageQuery, useGetUserLocationQuery, usePostUserLocationMutation } = shopApi